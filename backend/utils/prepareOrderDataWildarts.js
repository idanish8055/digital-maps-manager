module.exports.prepareOrderDataWildarts = async(orderData, shopify_details) => {
    ...
    if(lineItems.length > 0){
        for(let i = 0; i < lineItems.length; i++){
            ...
            console.log(metafieldResponse, shopify_details.shopify_access_token, "HEREEE!!!", shopify_details.shop_name, lineItems[i].product_id);
